...
export default function Projects({ data, github }: { data: any[]; github?: string }) {
      ...
      <div className="container">
        ...
        <div className={`${styles.grid} ${visible ? styles.gridVisible : ""}`}>
          {filtered.map((project, i) => {
            ...
            <div
              key={`${project.title}-${i}`}
              className={`${styles.card} ${project.featured ? styles.featured : ""} ${primaryUrl ? styles.clickable : ""}`}
              ...
              onKeyDown={(e) => { if (primaryUrl && (e.key === "Enter" || e.key === " ")) window.open(primaryUrl, "_blank", "noopener,noreferrer"); }}
            >
              <div className={styles.cardTop}>
                ...
                <div className={styles.cardLinks}>
                  {project.github && (
                    <a href={project.github} target="_blank" rel="noopener noreferrer" className={styles.iconLink} aria-label="GitHub" onClick={(e) => e.stopPropagation()}>
                  ...
                  {project.live && (
                    <a href={project.live} target="_blank" rel="noopener noreferrer" className={styles.iconLink} aria-label="Live Demo" onClick={(e) => e.stopPropagation()}>
