...
export default function Contact({ data, siteSettings, userId }: { data: any; siteSettings?: any; userId?: string }) {
  ...
  const infoItems = [
    { icon: "📍", label: "Location", value: siteSettings?.contactLocation || data?.location || "" },
    { icon: "📧", label: "Email", value: siteSettings?.contactEmail || data?.email || "" },
    { icon: "📱", label: "Phone", value: siteSettings?.contactPhone || data?.phone || "" },
    { icon: "🕐", label: "Availability", value: siteSettings?.contactAvailability || data?.availability || "" },
